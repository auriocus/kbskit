...
MAKEFLAGS=-j4 ./kbs.tcl -r -v -builddir="$(pwd)/$builddir" -make=make -tar=tar install kbskit8.6 sdx tablelist6.16 img1.4.13 tkdnd2.9 photoresize0.2 tdom0.9.2 vectcl0.3 vectcltk0.2 treectrl2.4.3 tcltls tktable2.10
