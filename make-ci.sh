...
MAKEFLAGS=-j4 ./kbs.tcl -r -v -builddir="$(pwd)/$builddir" -make=make install kbskit8.6 sdx tablelist6.16 img1.4.13 tkdnd2.9 photoresize0.2 rl_json0.11.1 tdom0.9.2
